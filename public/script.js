...
function openModal() {
    ...
    // Limpiar checkboxes de tecnologías
    const technologyCheckboxes = document.querySelectorAll('input[name="technologies"]');
...
function fillFormWithProject(project) {
    ...
    // Marcar las tecnologías del proyecto
...
async function handleFormSubmit(e) {
    ...
    try {
        ...
        // Recopilar tecnologías seleccionadas
        const selectedTechnologies = Array.from(document.querySelectorAll('input[name="technologies"]:checked'))
...
function validateProjectData(data) {
    ...
    if (!data.technologies || data.technologies.length === 0) {
        errors.push('Debe seleccionar al menos una tecnología');
    }
